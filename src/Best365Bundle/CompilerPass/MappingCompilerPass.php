	...
	public function process(ContainerBuilder $container)
	{
		$this
			...
			->addEntityMapping(
				$container,
				'default',
				'Best365Bundle\Entity\PaymentGateway',
			...
			->addEntityMapping(
				$container,
				'default',
				'Best365Bundle\Entity\CategoryExt',
				'@Best365Bundle/Resources/config/doctrine/CategoryExt.orm.yml',
				true
			)
			->addEntityMapping(
				$container,
				'default',
				'Best365Bundle\Entity\Bestselling',
			...
			->addEntityMapping(
				$container,
				'default',
				'Best365Bundle\Entity\CustomerExt',
				'@Best365Bundle/Resources/config/doctrine/CustomerExt.orm.yml',
				true
			)
		;
	}
